...
export const App = (props: AppContainerProps) => {
  const {onGameStart, screen, onCoalitionSelect, coalitionForOffer, onUndo,} = props;
  return (
    <React.Fragment>
      <TopBar onStartGame={onGameStart} onIntroClick={props.onGameRestart} screen={screen} onUndo={onUndo} />
      <Container className={"app"}>
        {screen === "INTRO" && <Intro />}
        {screen === "SELECT_COAL" && <SelectCoalition {...props} onCoalitionSelect={onCoalitionSelect} />}
