...
export const isOfferFinished = (o: Offer) => {
  return finiteStatus(o[Player.P1]) && finiteStatus(o[Player.P2]) && finiteStatus(o[Player.P3])
}
...
export const isOfferAccepted = (o: Offer) => {
  ...
  return acceptStatus(o[Player.P1]) && acceptStatus(o[Player.P2]) && acceptStatus(o[Player.P3])
}
